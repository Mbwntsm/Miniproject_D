...
<body>
    ...
    <nav class="navbar">
        <div class="nav-left">
            <ul>
                <li><a href="postL.php">Explore Work</a></li>
                <li><a href="viewLP.php">View Your Post</a></li>
                <li><a href="creatLpost.php">Create Post</a></li>
                <li><a href="#" class="btn btn-success" id="profile-link">View Profile</a></li>
            </ul>
        </div>
        <div class="nav-right">
